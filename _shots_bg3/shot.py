...
OUT = "/home/sergei/redesign-engine/experiments/notary-tarakanovsky/_shots_bg3"
...
with sync_playwright() as p:
    ...
    time.sleep(1.5)
    for sec in ["home", "services", "about", "how", "reviews", "faq", "contacts"]:
    ...
    page.goto(URL, wait_until="networkidle")
    time.sleep(1.5)
    for sec in ["services", "about", "faq", "contacts"]:
        page.evaluate(f"window.NB.goId('{sec}')")
        time.sleep(2.5)
